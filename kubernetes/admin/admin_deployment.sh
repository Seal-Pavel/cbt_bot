...
echo "Creating secret.yaml file from .env.bot..."
kubectl create secret generic env --from-env-file=../../admin_app/.env.admin --dry-run=client -o yaml > secret_admin.yaml
